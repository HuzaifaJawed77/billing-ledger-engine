...
import {subscribeHandler,getSubscriptionHandler,cancelSubscriptionHandler , changePlanHandler} from "./subscription.controller";
...
subscriptionRouter.patch("/:id/change-plan", authenticate, changePlanHandler);